...
GLvoid CRun_time_Framework::shape_draw() {
	...
	if (mod == 1)
		gluLookAt(player.x + sin(pi / 180 * (player.dir * 90)) * 100, player.y + 50, player.z + cos(pi / 180 * (player.dir * 90)) * 100, player.x, player.y, player.z, 0, 1, 0);
